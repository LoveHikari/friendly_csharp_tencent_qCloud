...
namespace FsLib.Tencent.QCloud.SDK.Common
{
    internal class Sign
    {
        ...
        /// <returns></returns>
        internal static string Signature(int appId, string secretId, string secretKey, long expired, string bucketName)
        {
        ...
        /// <param name="bucketName"></param>
        /// <returns></returns>
        internal static string SignatureOnce(int appId, string secretId, string secretKey, string remotePath, string bucketName)
        {
